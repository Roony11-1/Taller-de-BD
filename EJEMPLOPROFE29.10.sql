...
CREATE OR REPLACE TRIGGER TRG_ASIG_COM_JOB_SA_REP
BEFORE INSERT OR UPDATE OF salary ON EMPLEADOS
FOR EACH ROW
...
BEGIN
    ...
    ELSE
        :NEW.commission_pct := NVL(:OLD.commission_pct, 0)+ 0.05;
    END IF;
END;

INSERT INTO EMPLEADOS VALUES (995, 'EMA', 'STONE', 'ESTONE', NULL, SYSDATE, 'SA_REP', 4000, 0, NULL, NULL);